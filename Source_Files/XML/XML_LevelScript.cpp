...
void RunLevelScript(int LevelIndex)
{
	...
	else
	{
		...
		printf("Reseting all values to engine defaults...");
		//MKTODO UNCOMMENT
		//ResetAllMMLValues();
		printf("Done.\n");
		// then load the base stuff (from Scripts folder and whatnot)
		printf("Load base MML Scripts...");
		//LoadBaseMMLScripts();
		printf("Done.\n");
	}
	
	printf("General run scripts...");
