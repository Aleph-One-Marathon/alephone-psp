...
#ifdef PSP
	printf("PSP - IMAGE FILE: %s\n",getcstr(temporary, strFILENAMES, filenameIMAGES));
#endif
...
#ifdef PSP
		printf("PSP - Image file not resource\n");
#endif
...
#ifdef PSP
		printf("PSP - Image file not a wad\nPSP - Image file invalid\n");
#endif
