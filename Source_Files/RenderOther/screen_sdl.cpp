...
#include "network.h"
#ifdef PSP
// MK: Needed for rescale_surface used
//		for resizing the HUD
#include "images.h"
#endif
...
#ifdef PSP
	printf("Changing screen mode w = %d, h = %d, depth = %d, opengl %s\n",
			width, height, depth, (nogl ? "disabled" : "enabled"));
#endif
